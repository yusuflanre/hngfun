...
<div class="row clear-fix past-internships-container">
    <div class="column">
        <div>
            <a href="#v3">
                <img src="http://blog.hotels.ng/wp-content/uploads/2017/01/RIP_Interns.png" alt="HNG Internship 3.0">
                <h3>HNG Internship 3.0</h3>
                <div class="internship-content">
                    Slack is a popular communication tool that companies and teams worldwide use. At hotels.ng, we use Slack too, but in ways that best suit our company culture and that bring out the best in us. Slack was originally designed to enable communication in a team that was put together to design an online game. The... 
                    <a class="button read-more-button" href="#v3">Read More</a>
                </div>
            </a>
        </div>
    </div>
    <div class="column">
        <div>
            <a href="#v2">
                <img src="http://blog.hotels.ng/wp-content/uploads/2016/09/lines-of-code.jpeg" alt="HNG Internship 2.0">
                <h3>HNG Internship 2.0</h3>
                <div class="internship-content">
                    Slack is a popular communication tool that companies and teams worldwide use. At hotels.ng, we use Slack too, but in ways that best suit our company culture and that bring out the best in us. Slack was originally designed to enable communication in a team that was put together to design an online game. The... 
                    <a class="button read-more-button" href="#v2">Read More</a>
                </div>
            </a>
        </div>
    </div>
    ...
    <div class="column">
        <div>
            <a href="#v1">
                <img src="http://blog.hotels.ng/wp-content/uploads/2016/11/pexels-photo.jpg" alt="HNG Internship 1.0">
                <h3>HNG Internship 1.0</h3>
                <div class="internship-content">
                    Slack is a popular communication tool that companies and teams worldwide use. At hotels.ng, we use Slack too, but in ways that best suit our company culture and that bring out the best in us. Slack was originally designed to enable communication in a team that was put together to design an online game. The... 
                    <a class="button read-more-button" href="#v1">Read More</a>
                </div>
            </a>
        </div>
    </div>
...
<style type="text/css">
    ...
    .internship-content, .internship-detail {
        padding: 12px;
        color: #555 !important;
    }
    #header {  
    /**
    absolute positioning makes our container div to stay on top of the header
    so we use relative instead
    */
